...
public class IniciarSesionVista extends javax.swing.JFrame {
     ...
     */
    public IniciarSesionVista() throws Exception {
        encoder = new Encoder();
        initComponents();
    ...
    private void btnIniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIniciarActionPerformed
        try {
            ...
            Utilidades.validarCampoTexto(login, "Usuario");
            String password = encoder.encrypt(this.txtContrasenia.getText());
            Utilidades.validarCampoTexto(password, "Contrasena");
            Empleado empleado = this.empleadoService.consultarEmpleado(login, password);
            SessionService.setSesionEmpleado(empleado);
            irAlHome();
        } catch(Exception ex) {
